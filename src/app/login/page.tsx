...
export default function LoginPage() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({ title: "Account Created", description: "Welcome to Finova! Redirecting..." })
      // Force a hard refresh to ensure auth state is updated
      setTimeout(() => {
        window.location.href = "/"
      }, 1000)
    ...
    <div className="flex min-h-screen items-center justify-center bg-muted/30 p-4">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          <h1 className="text-4xl font-bold tracking-tight text-primary">Finova</h1>
          <p className="mt-2 text-muted-foreground">Seamlessly manage your expenses.</p>
        </div>
